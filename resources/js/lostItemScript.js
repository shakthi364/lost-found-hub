 // Toggle filter sections
        ...
        const setAlertBtn = document.querySelector('button:contains("Set Up Alerts")');
        const closeAlertModal = document.getElementById('closeAlertModal');
        const cancelAlert = document.getElementById('cancelAlert');

        // Show alert modal
        document.querySelector('button:contains("Set Up Alerts")').addEventListener('click', function() {
